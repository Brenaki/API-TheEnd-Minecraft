...
# Hi, I'm Victor and I'm creating a API for accessing a dimension The End, of minecraft. And the code is in two
# languages, English and Portuguese. So if you don't understand Portuguese, you're going to read the API in English.

# Olá, sou o Victor e estou criando uma API para acessar a dimensão do Fim, do minecraft. E o código está em dois
# idiomas, Inglês e Português. Então, se você não entende inglês, Você vai ler a API em português.
    ...
    if request.method == 'GET':
        return {
            ...
            'Ambiente': {
                ...
                'recursos_de_terreno': {
                    # Recursos de Terreno
                    'Ilha_principal': 'Na ilha principal, há dez torres de obsidiana com cristais do End no topo, '
                    ...
                    'Ilhas_externas': 'As ilhas externas do End são lugares misteriosos e isolados que só podem ser '
...
def en():
    if request.method == 'GET':
        return {
            # Accessing
            'Access': 'To reach the End, the player needs to find a stronghold using eyes of ender and locate the portal '
                      'room. The room has an End portal with 12 frames, some with eyes already inserted. The player needs '
